...
/**
 *   @description: This will display each thrust curve using a freechart library
...
public class ThrustCurveViewActivity extends AppCompatActivity {
 ...
 protected void onCreate(Bundle savedInstanceState) {
     ...
     setContentView(R.layout.activity_thrustcurve_view);
     buttonDismiss =  (Button) findViewById(R.id.butDismiss);

     Log.d("FVIEW", "Test Stand name: "+ myBT.getTestStandConfigData().getTestStandName());
     ...
     flightData = mythrustCurve.GetThrustCurveData(ThrustCurveName);
